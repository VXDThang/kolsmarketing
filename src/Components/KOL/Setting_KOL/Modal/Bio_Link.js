...
export default function Bio_Link(props) {
    ...
    return (
        <div>
            ...
            <div className='d-flex justify-content-between' style={{ minWidth: "430px", paddingTop: "20px" }}>
            ...
            {list_Bio.length > 0 && list_Bio.map((data, index) => {
                return (
                    ...
                    <div key={index} style={{ marginTop: "5px", marginBottom: "5px", maxWidth: "430px" }}>
                        <Divider sx={{ color: "#00B14F" }} />
                        <Grid container sx={{
                            paddingTop: "10px", paddingBottom: "10px",
                            "&:hover": { bgcolor: "#F1F2F6" }
                        }}>
                            <Grid item xs={10.5} sx={{ wordWrap: "break-word" }}>
                                {data}
                            </Grid>
                            <Grid
                                display="flex"
