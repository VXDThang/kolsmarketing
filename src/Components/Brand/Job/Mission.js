...
//Modal
import Result_ListDraftPostSubmit from '../../Modals/Result_ListDraftPostSubmit'
...
export default function Mission({ key, detail_mision }) {
    let actoken = localStorage.access_token;
    const [comment, setComment] = React.useState('');
    const [listComment, setListComment] = React.useState([]);
    const [expanded, setExpanded] = React.useState(false);
    const [openListDraftPostSubmit, setOpenListDraftPostSubmit] = React.useState(false);
    
    const handleExpandClick = () => {
        setExpanded(!expanded);
    };

const handleOpenListDraftPostSubmit =()=> {setOpenListDraftPostSubmit(true)}
    ...
    return (
        <div>
            <div style={{ paddingTop: "10px", paddingBottom:"10px" }}>
                <Card sx={{ Width: "45%",  borderLeft: detail_mision?.type == "2" ? '0.2em solid #F0C01D' :'0.2em solid #00B14F', 
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <div>
                            <Button fullWidth variant="contained"
                                ...
                                onClick={handleOpenListDraftPostSubmit}
                            >
                                Kết quả
                            </Button>
                        </div> : ""}                            
            ...
            <Result_ListDraftPostSubmit
                    isOpen={openListDraftPostSubmit}
                    isClose={(value) => setOpenListDraftPostSubmit(false)}
