...
const Content_Homepage = () => {
  ...
  if (listNewestPost.length > 0)
    currentTodos = listNewestPost.slice(indexOfFirstNews, indexOfLastNews); //*cắt* dữ liệu ban đầu, lấy ra 1 mảng dữ liệu mới cho trang hiện tại
              ...
              <Grid item xs={12}>
                <div className='d-flex justify-content-between'>
                  <div style={{ fontSize: 18, fontWeight: "700" }}>
                    <StarsIcon sx={{ fontSize: 28, fontWeight: "900", paddingBottom: 1, color: "#00B14F" }} />CƠ HỘI MỚI
                  </div>
            ...
            <div>
              <div className="back-ground-content-job" style={{ paddingLeft: "15px", paddingRight: "15px", paddingTop: "10px", paddingBottom: "10px" }}>
                ...
                <Grid container spacing={2}>
                  {currentTodos.length > 0 && currentTodos.map((list) => (
