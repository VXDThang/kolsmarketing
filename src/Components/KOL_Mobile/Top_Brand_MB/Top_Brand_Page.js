    ...
    return (
        <div>
            <div className="backGround_search" style={{borderRadius: "5px"}}>
                <div style={{ paddingLeft: "10px", paddingTop: "20px", paddingBottom: "15px", paddingRight:"10px"  }}>
                    <div 
                    style={{ fontSize: "24px", color: "#329D9C", fontWeight: 600, paddingBottom: "40px"}}>
                        Khám phá Top 100+ Nhãn hàng
                    </div>
