      ...
      <div className="back-ground-content">
        <div ref={loadingPageRef}
          ...
          <div style={{ paddingBottom: "30px" }}>
            <Card className="card-job" sx={{ display: 'flex', height: 200, flexDirection: 'column', }}>
              <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                <CardMedia
                  component="img"
                  sx={{  minWidth: 120, maxWidth:120, height: 120, borderRadius: "5px" }}
                ...
                <div className="d-flex align-items-center">
                  <div style={{ fontSize: "16px", paddingLeft: "10px", paddingTop: "5px" }}>
                    <div >
                      <div className="title0newMB"
                        style={{ fontWeight: "700", color: "#2C6975", fontSize: "18px" }}>
                        {detailPost.title}
                      </div>
                    </div>
                    ...
                    <div>
                      <span style={{}}> {detailPost.views} lượt xem</span>
                    </div>
          ...
          <div style={{ marginBottom: "-10px" }} >
            ...
            <div style={{ fontWeight: 500, color: "#660066", cursor: "pointer" }}
              onClick={executeInforPostScroll}>Thông tin cơ hội →</div>
            <div style={{ fontWeight: 500, color: "#660066", cursor: "pointer" }}
              onClick={executeInforBrandScroll}>Thông tin nhãn hàng →</div>
            <div style={{ fontWeight: 500, color: "#660066", cursor: "pointer" }}
              onClick={executeSuggestScroll}>Những cơ hội khác →</div>
