  ...
  return (
    <div >
      ...
      <Card className="card-job"
        sx={{
          display: 'flex', height: 140, flexDirection: 'column',
          "&:hover": { bgcolor: "#edf4fb" }
        }} >
        <Box sx={{ display: 'flex', flexDirection: 'row' }}>
          ...
          />
          <div style={{ fontSize: "16px", paddingLeft: "10px",marginRight: "5px", paddingTop: "10px" }}>
            <div >
              <div className="title0new_CardMB" style={{ fontWeight: "700", cursor: "pointer" }} onClick={(e) => { handleClickReadOne(e, id) }} >
                {title}
              </div>
              <div className="card0heart" style={{ paddingRight: "5px", paddingTop:"25px" }}>
                <Checkbox {...label}
